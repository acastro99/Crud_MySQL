...
public class Inicio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (inputEt && inputEd && input1){
                    ...
                    manto.guardar(Inicio.this, codigo, descripcion, precio);
        ...
        btn_eliminar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(inputEt){
                    String codigo = et_codigo.getText().toString();
                    manto.eliminar(Inicio.this, codigo);
        ...
        btn_consultaCodigo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(inputEt) {
                    String codigo = et_codigo.getText().toString();
                    manto.consultarCodigo(Inicio.this, codigo);
                    et_codigo.requestFocus();
                }
                //End
        ...
        btn_consultaDescripcion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(inputEd){
                    ...
                    manto.consultarDescripcion(Inicio.this, descripcion);
        ...
        btn_actualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(inputEt) {
                    ...
                    manto.modificar(Inicio.this, datos);
                    limpiarDatos();
                    et_codigo.requestFocus();
                }
    ...
    private void DialogConfirmacion(){
        ...
        dialogo = new AlertDialog.Builder(Inicio.this);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        String cod = getSharedCodigo(Inicio.this);
                        String des = getSharedDescripcion(Inicio.this);
                        String pre = getSharedPrecio(Inicio.this);
